...
-- vulns:
INSERT INTO vulns(name, data, server_id) VALUES("Weak-User", "Admin user has weak name and password.", 1);

-- Sections:
INSERT INTO sections(name) VALUES("Network");
INSERT INTO sections(name) VALUES("SecondNet");
...
INSERT INTO files(name, path,description, server_id) VALUES("1.txt","files\1.txt","Lorem", 1);
...
INSERT INTO users(type, server_id, username, password, permissions) VALUES(1, 1, "Baba", "Bb123123", "READ");

-- comments:
INSERT INTO comments(data, executor) VALUES("Comments now works, Try it out.", "Daniel");
